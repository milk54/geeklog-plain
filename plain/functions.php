 ...
 */
function theme_css_plain()
{
    global $_CONF, $LANG_DIRECTION;

    $theme_var = theme_config_plain();
 ...
 *
 */
function theme_getCSSClasses_plain($item)
{
    $retval = '';
